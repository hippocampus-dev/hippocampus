...
kubectl delete validatingwebhookconfiguration -l release!=istio
kubectl delete mutatingwebhookconfiguration -l release!=istio

kubectl delete pod -l app.kubernetes.io/name=cilium-agent -n kube-system
