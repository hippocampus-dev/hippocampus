...
Before adjusting any workload, check git log for the past 7 days. If a workload's resource requests or limits were already adjusted within the past 7 days, skip it unless the workload is currently experiencing OOMKill, CrashLoopBackOff, or CPU throttling.
