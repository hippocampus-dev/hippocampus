...
RESOURCE_OPTION="--extra-config=kubelet.max-pods=300 --cpus=16 --memory=56g --disk-size=200g --extra-config=kubelet.system-reserved=cpu=500m,memory=1Gi,ephemeral-storage=10Gi,pid=1000"
