...
complete -c kubectl -x -l cluster -d 'The name of the kubeconfig cluster to use' -a '(__fish_kubectl config get-clusters --no-headers | cut -d" " -f1)'
complete -c kubectl -x -l context -d 'The name of the kubeconfig context to use' -a '(__fish_kubectl config get-contexts --no-headers | cut -d" " -f3)'
...
complete -c kubectl -x -s n -l namespace -d 'If present, the namespace scope for this CLI request' -a '(__fish_kubectl get namespace --no-headers | cut -d" " -f1)'
