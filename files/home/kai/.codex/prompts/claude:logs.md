...
Run this command and use its output as context: `basename "$(pwd)"`

## Log Directory

Run this command and use its output as context: `echo "${HOME}/.config/claudex/config/projects/$(pwd | sed 's|/|-|g')"`

## Recent Log Files (last 5)

Run this command and use its output as context: `ls -lt "${HOME}/.config/claudex/config/projects/$(pwd | sed 's|/|-|g')"/*.jsonl 2>/dev/null | head -5`
