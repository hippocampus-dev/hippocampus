...
CLAUDE_CONFIG_DIR=~/.config/claudex/config claude mcp add -t stdio notify --scope user -- armyknife mcp notify
CLAUDE_CONFIG_DIR=~/.config/claudex/config claude mcp add -t stdio gemini --scope user -- armyknife mcp gemini
CLAUDE_CONFIG_DIR=~/.config/claudex/config claude mcp add -t stdio codex --scope user -- armyknife mcp codex
CLAUDE_CONFIG_DIR=~/.config/claudex/config claude mcp add -t stdio claude --scope user -- armyknife mcp claude
#CLAUDE_CONFIG_DIR=~/.config/claudex/config claude mcp add -t sse playwright --scope user -- http://playwright-mcp.127.0.0.1.nip.io/sse
#CLAUDE_CONFIG_DIR=~/.config/claudex/config claude mcp add -t sse chrome-devtools --scope user -- http://chrome-devtools-mcp.127.0.0.1.nip.io/sse
CLAUDE_CONFIG_DIR=~/.config/claudex/config claude mcp add -t stdio chrome-devtools --scope user -- chrome-devtools-mcp --browserUrl http://127.0.0.1:59222
CLAUDE_CONFIG_DIR=~/.config/claudex/config claude mcp add -t http graphiti --scope user -- http://graphiti-mcp-server.127.0.0.1.nip.io/mcp
CLAUDE_CONFIG_DIR=~/.config/claudex/config claude mcp add -t http spotify --scope user -- https://spotify-mcp-server-public.kaidotio.dev/mcp
#CLAUDE_CONFIG_DIR=~/.config/claudex/config claude mcp add -t http gmail --scope user -- https://gmail.mcp.claude.com/mcp
#CLAUDE_CONFIG_DIR=~/.config/claudex/config claude mcp add -t http gcal --scope user -- https://gcal.mcp.claude.com/mcp
