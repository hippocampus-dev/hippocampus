...
A Tauri-based Android timer application with multi-timer support, background service, and alarm notifications.
...
│   │   ├── tauri-plugin-gemini/  # On-device AI categorization
