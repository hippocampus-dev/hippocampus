...
### Structure
- `google.tf` - Google Cloud resources (Storage buckets, Workload Identity Federation, service accounts)
- `cloudflare.tf` - Cloudflare resources (Zone, Pages, Zero Trust, KV)
- `github.tf` - GitHub repository rulesets
