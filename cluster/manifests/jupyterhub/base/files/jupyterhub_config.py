...
c.KubeSpawner.service_account = "singleuser"
c.KubeSpawner.automount_service_account_token = True
c.KubeSpawner.image = "ghcr.io/kaidotio/hippocampus/singleuser-notebook:main"
...
c.ConfigurableHTTPProxy.api_url = "http://proxy.jupyterhub.svc.cluster.local:8000"
c.ConfigurableHTTPProxy.log_level = "warn"

hub_container_port = 8081
c.JupyterHub.hub_bind_url = f"http://0.0.0.0:{hub_container_port}"
c.JupyterHub.hub_connect_url = f"http://hub.jupyterhub.svc.cluster.local:{hub_container_port}"
