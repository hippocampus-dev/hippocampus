...
docker build -t ghcr.io/hippocampus-dev/hippocampus/jupyterhub .

# Build single-user notebook image
cd /opt/hippocampus/cluster/applications/singleuser-notebook
docker build -t ghcr.io/hippocampus-dev/hippocampus/singleuser-notebook .

# Build configurable-http-proxy image
cd /opt/hippocampus/cluster/applications/configurable-http-proxy
docker build -t ghcr.io/hippocampus-dev/hippocampus/configurable-http-proxy .
```
...
cd base/
kustomize edit set image ghcr.io/hippocampus-dev/hippocampus/jupyterhub=ghcr.io/hippocampus-dev/hippocampus/jupyterhub@sha256:<new-digest>
