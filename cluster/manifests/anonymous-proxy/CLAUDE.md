...
cd base
kustomize edit set image ghcr.io/kaidotio/hippocampus/anonymous-proxy=ghcr.io/kaidotio/hippocampus/anonymous-proxy@sha256:new-digest
```
...
### Kustomize Structure
- **base/**: Core Kubernetes resources (deployment, service, HPA, PDB)
