...
### Update images
When updating cert-manager versions, update the image digests in `base/kustomization.yaml`. All images must be mirrored to `ghcr.io/hippocampus-dev/hippocampus/mirror/`.
