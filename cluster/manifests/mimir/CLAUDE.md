...
2. **Supporting Services**:
   - **MinIO**: S3-compatible object storage for blocks and alerts
...
- **Object Storage**: MinIO for TSDB blocks and ruler/alertmanager data
- **Local Storage**: Persistent volumes for ingester WAL
