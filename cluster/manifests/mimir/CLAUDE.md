...
- Alertmanager configuration is managed declaratively via ConfigMap (`alertmanager.yaml`)
- ConfigMap is mounted directly to `/etc/mimir/alertmanager/anonymous/`
- Notifications are sent to Mattermost via Slack-compatible webhook