...
- **Tempo**: Trace data export endpoint at `tempo-distributor.tempo.svc.cluster.local:4317`
- **Service Mesh**: Istio sidecar injection for secure communication
- **Monitoring**: Exposes internal metrics on port 8888, scraped by Prometheus via Istio merge-metrics (port 15020)
