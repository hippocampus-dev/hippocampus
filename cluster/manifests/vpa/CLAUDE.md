...
### Image Management
All container images are mirrored to `ghcr.io/kaidotio/hippocampus/mirror/` for reliability and access control. Image digests are pinned in base/kustomization.yaml:
