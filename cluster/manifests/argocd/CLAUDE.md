...
2. **Image Mirroring**: All container images are pulled from a private registry (`ghcr.io/kaidotio/hippocampus/mirror/`) for security and reliability
...
5. **GitOps Configuration**:
   - Repository: `git@github.com:kaidotio/hippocampus`
