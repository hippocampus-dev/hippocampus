...
1. **Base Layer** (`base/`):
   - References upstream Knative Eventing Kafka resources (v1.20.1)
...
- Hosts KafkaTopics for `loganomaly` (Strimzi Topic Operator only watches KafkaTopics in the Kafka cluster's namespace)
