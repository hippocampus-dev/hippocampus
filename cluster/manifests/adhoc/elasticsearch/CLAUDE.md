...
- **Ingest nodes** (1-3x): Data preprocessing, autoscaling enabled
- **Coordinating nodes** (1-3x): Request routing, autoscaling enabled
...
- Horizontal pod autoscaling for stateless nodes (1-3 replicas based on CPU/memory)
