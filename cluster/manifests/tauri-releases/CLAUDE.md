...
cd base
kustomize edit set image ghcr.io/hippocampus-dev/hippocampus/tauri-releases=ghcr.io/hippocampus-dev/hippocampus/tauri-releases@sha256:NEW_DIGEST
```
...
- **HPA**: Auto-scales based on CPU/memory (1-3 replicas)
