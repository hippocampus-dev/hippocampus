...
- **`overlays/dev/`** - Development environment specific patches
  ...
  - Configures Istio service mesh integration (mTLS, sidecar egress, telemetry)
...
4. **Mirrored Images**: Uses `ghcr.io/hippocampus-dev/hippocampus/mirror/` prefix for all images
