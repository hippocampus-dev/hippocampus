...
All TiDB images are mirrored to `ghcr.io/kaidotio/hippocampus/mirror/pingcap/*` to ensure availability and reduce external dependencies. The base kustomization specifies image digests for:
