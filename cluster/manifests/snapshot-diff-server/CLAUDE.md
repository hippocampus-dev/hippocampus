...
### Container Image
- Registry: `ghcr.io/kaidotio/hippocampus/snapshot-controller/snapshot-diff-server`
...
- digest: sha256:NEW_DIGEST_HERE
  name: ghcr.io/kaidotio/hippocampus/snapshot-controller/snapshot-diff-server
  newName: ghcr.io/kaidotio/hippocampus/snapshot-controller/snapshot-diff-server
```
