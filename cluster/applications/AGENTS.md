...
## .claude/rules/cluster/applications.md

Directory scope: `cluster/applications/**`
...
- When a target path matches `cluster/applications/*/manifests/**/*.yaml`, read and follow `.claude/rules/cluster/manifests.md` before proceeding.
