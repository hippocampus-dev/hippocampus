...
class CompletionModel(enum.StrEnum):
    ...
    GPT_54_ALIAS = "gpt-5.4"
    GPT_54 = "gpt-5.4-2026-02-27"
    GPT_54_MINI_ALIAS = "gpt-5.4-mini"
    GPT_54_MINI = "gpt-5.4-mini-2026-03-17"
    ...
    def prices(self) -> collections.abc.Mapping[str, float]:
        match self:
            ...
            case CompletionModel.GPT_54 | CompletionModel.GPT_54_ALIAS:
                return {
                    "price_per_prompt": 2.5 / 1000 / 1000,
                    "price_per_completion": 15 / 1000 / 1000,
                }
            case CompletionModel.GPT_54_MINI | CompletionModel.GPT_54_MINI_ALIAS:
                return {
                    "price_per_prompt": 0.75 / 1000 / 1000,
                    "price_per_completion": 4.5 / 1000 / 1000,
                }
            ...
            case (
                CompletionModel.GPT_51
                | CompletionModel.GPT_51_ALIAS
                | CompletionModel.GPT_5
                | CompletionModel.GPT_5_ALIAS
            ):
                return {
            ...
            case (
                ...
                | CompletionModel.O4_MINI_ALIAS
                | CompletionModel.O3_MINI
                | CompletionModel.O3_MINI_ALIAS
                | CompletionModel.O1_MINI
                | CompletionModel.O1_MINI_ALIAS
            ):
                return {
            ...
            case (
                CompletionModel.O1_PREVIEW
                | CompletionModel.O1_PREVIEW_ALIAS
                | CompletionModel.O1
                | CompletionModel.O1_ALIAS
            ):
                return {
            ...
            case (
                CompletionModel.GPT4_TURBO_PREVIEW_ALIAS
                | CompletionModel.GPT4_TURBO
                | CompletionModel.GPT4_TURBO_ALIAS
                | CompletionModel.GPT4_TURBO_VISION
            ):
                return {
                    "price_per_prompt": 10 / 1000 / 1000,
            ...
            case (
                CompletionModel.GPT35_TURBO_16K | CompletionModel.GPT35_TURBO_16K_ALIAS
            ):
                return {
                    "price_per_prompt": 0.5 / 1000 / 1000,
                    "price_per_completion": 1.5 / 1000 / 1000,
    ...
    def max_tokens(self) -> int:
        match self:
            case CompletionModel.GPT_54 | CompletionModel.GPT_54_ALIAS:
                return 1_050_000
            case (
                CompletionModel.GPT_54_MINI
                | CompletionModel.GPT_54_MINI_ALIAS
                | CompletionModel.GPT_52
                | CompletionModel.GPT_52_ALIAS
                | CompletionModel.GPT_51
                | CompletionModel.GPT_51_ALIAS
                | CompletionModel.GPT_5
                | CompletionModel.GPT_5_ALIAS
                | CompletionModel.GPT_5_MINI
                | CompletionModel.GPT_5_MINI_ALIAS
                | CompletionModel.GPT_5_NANO
                | CompletionModel.GPT_5_NANO_ALIAS
            ):
                return 400000
            case (
                CompletionModel.GPT41
                | CompletionModel.GPT41_ALIAS
                | CompletionModel.GPT41_MINI
                | CompletionModel.GPT41_MINI_ALIAS
                | CompletionModel.GPT41_NANO
                | CompletionModel.GPT41_NANO_ALIAS
            ):
                return 1_047_576
            case (
                CompletionModel.O4_MINI
            ...
            case (
                CompletionModel.O1_MINI
                | CompletionModel.O1_MINI_ALIAS
                | CompletionModel.GPT4O_LONG_OUTPUT
                | CompletionModel.CHATGPT_4O
                | CompletionModel.GPT4O
                | CompletionModel.GPT4O_ALIAS
                | CompletionModel.GPT4O_MINI
                | CompletionModel.GPT4O_MINI_ALIAS
                | CompletionModel.GPT4_TURBO_PREVIEW_ALIAS
                | CompletionModel.GPT4_TURBO
                | CompletionModel.GPT4_TURBO_ALIAS
                | CompletionModel.GPT4_TURBO_VISION
    ...
    def max_completion_tokens(self) -> int | None:
        match self:
            ...
            case (
                ...
                | CompletionModel.GPT4_TURBO_ALIAS
                | CompletionModel.GPT4_TURBO_VISION
                | CompletionModel.GPT35_TURBO
                | CompletionModel.GPT35_TURBO_ALIAS
            ):
                return 4096
            case (
                CompletionModel.GPT4_32K
                | CompletionModel.GPT4_32K_ALIAS
                | CompletionModel.GPT35_TURBO_16K
                | CompletionModel.GPT35_TURBO_16K_ALIAS
            ):
                return None
            case _:
                return None
    ...
    def reasoning_supported(self):
        match self:
            case (
                CompletionModel.GPT_54
                | CompletionModel.GPT_54_ALIAS
                | CompletionModel.GPT_54_MINI
                | CompletionModel.GPT_54_MINI_ALIAS
                | CompletionModel.GPT_52
                | CompletionModel.GPT_52_ALIAS
...
class ImageModel(enum.StrEnum):
    ...
    def price(self) -> float:
        match self:
            case (
                ImageModel.Low15_1024x1024
                | ImageModel.Low15_1024x1536
                | ImageModel.Low15_1536x1024
                | ImageModel.Medium15_1024x1024
                | ImageModel.Medium15_1024x1536
                | ImageModel.Medium15_1536x1024
                | ImageModel.High15_1024x1024
                | ImageModel.High15_1024x1536
                | ImageModel.High15_1536x1024
            ):
                return 0
    ...
    def model_name(
        ...
        match self:
            ...
            case (
                ImageModel.Low1024x1024
                | ImageModel.Low1024x1536
                | ImageModel.Low1536x1024
                | ImageModel.Medium1024x1024
                | ImageModel.Medium1024x1536
                | ImageModel.Medium1536x1024
                | ImageModel.High1024x1024
                | ImageModel.High1024x1536
                | ImageModel.High1536x1024
            ):
                return "gpt-image-1"
            case (
                ImageModel.Standard1024x1024
                | ImageModel.Standard1024x1792
                | ImageModel.Standard1792x1024
                | ImageModel.HD1024x1024
                | ImageModel.HD1024x1792
                | ImageModel.HD1792x1024
            ):
                return "dall-e-3"
    ...
    def quality(
        self,
    ) -> typing_extensions.Literal["standard", "hd", "low", "medium", "high"]:
        match self:
            case (
                ImageModel.Standard1024x1024
                | ImageModel.Standard1024x1792
                ...
                return "standard"
            case (
                ImageModel.HD1024x1024 | ImageModel.HD1024x1792 | ImageModel.HD1792x1024
            ):
                return "hd"
            case (
                ImageModel.Low15_1024x1024
