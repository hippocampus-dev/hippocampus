...
class CompletionModel(enum.StrEnum):
    ...
    def max_tokens(self) -> int:
        match self:
            ...
            case CompletionModel.GPT_51 | CompletionModel.GPT_51_ALIAS | CompletionModel.GPT_5 | CompletionModel.GPT_5_ALIAS:
                return 400000
            case CompletionModel.O4_MINI | CompletionModel.O4_MINI_ALIAS | CompletionModel.O3_PRO | CompletionModel.O3_PRO_ALIAS | CompletionModel.O3 | CompletionModel.O3_ALIAS | CompletionModel.O3_MINI | CompletionModel.O3_MINI_ALIAS | CompletionModel.O1_PREVIEW | CompletionModel.O1_PREVIEW_ALIAS | CompletionModel.O1 | CompletionModel.O1_ALIAS:
                return 200000
    ...
    def reasoning_supported(self):
        match self:
            case CompletionModel.GPT_51 | CompletionModel.GPT_51_ALIAS | CompletionModel.GPT_5 | CompletionModel.GPT_5_ALIAS | CompletionModel.O4_MINI | CompletionModel.O4_MINI_ALIAS | CompletionModel.O3_PRO | CompletionModel.O3_PRO_ALIAS | CompletionModel.O3 | CompletionModel.O3_ALIAS | CompletionModel.O3_MINI | CompletionModel.O3_MINI_ALIAS | CompletionModel.O1_PREVIEW | CompletionModel.O1_PREVIEW_ALIAS | CompletionModel.O1 | CompletionModel.O1_ALIAS:
                return True
            case _:
                return False
    ...
    def image_url_supported(self):
        match self:
            case CompletionModel.GPT_51 | CompletionModel.GPT_51_ALIAS | CompletionModel.GPT_5 | CompletionModel.GPT_5_ALIAS | CompletionModel.GPT41 | CompletionModel.GPT41_ALIAS | CompletionModel.GPT41_MINI | CompletionModel.GPT41_MINI_ALIAS | CompletionModel.GPT41_NANO | CompletionModel.GPT41_NANO_ALIAS | CompletionModel.CHATGPT_4O | CompletionModel.GPT4O | CompletionModel.GPT4O_ALIAS | CompletionModel.GPT4O_MINI | CompletionModel.GPT4O_MINI_ALIAS | CompletionModel.GPT4_TURBO | CompletionModel.GPT4_TURBO_ALIAS | CompletionModel.GPT4_TURBO_VISION:
                return True
            case _:
                return False
...
class ImageModel(enum.StrEnum):
    ...
    @property
    def model_name(self) -> typing_extensions.Literal["gpt-image-1", "dall-e-3", "dall-e-2"]:
        match self:
    ...
    def quality(self) -> typing_extensions.Literal["standard", "hd", "low", "medium", "high"]:
        match self:
            ...
            case ImageModel.HD1024x1024 | ImageModel.HD1024x1792 | ImageModel.HD1792x1024:
                return "hd"
            case ImageModel.Low1024x1024 | ImageModel.Low1024x1536 | ImageModel.Low1536x1024:
                return "low"
            case ImageModel.Medium1024x1024 | ImageModel.Medium1024x1536 | ImageModel.Medium1536x1024:
                return "medium"
            case ImageModel.High1024x1024 | ImageModel.High1024x1536 | ImageModel.High1536x1024:
                return "high"
        raise ValueError(f"Unknown model: {self}")
    ...
    def resolution(self) -> typing_extensions.Literal[
        ...
        match self:
            case ImageModel.Low1024x1024 | ImageModel.Medium1024x1024 | ImageModel.High1024x1024 | ImageModel.Standard1024x1024 | ImageModel.HD1024x1024 | ImageModel.x1024:
                return "1024x1024"
            case ImageModel.Low1024x1536 | ImageModel.Medium1024x1536 | ImageModel.High1024x1536:
                return "1024x1536"
            case ImageModel.Low1536x1024 | ImageModel.Medium1536x1024 | ImageModel.High1536x1024:
                return "1536x1024"
