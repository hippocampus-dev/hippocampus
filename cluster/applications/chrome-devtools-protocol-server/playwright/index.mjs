...
async function testSingleClient(endpointUrl, targetUrl, clientId) {
...
await testSingleClient(endpointUrl, targetUrl, 1);

await Promise.all(
  [2, 3, 4].map((id) => testSingleClient(endpointUrl, targetUrl, id)),
);
