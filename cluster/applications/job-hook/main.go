...
func apiGroup() string {
	defaultGroup := "job-hook.kaidotio.github.io"
...
func (h *handler) Handle(ctx context.Context, req admission.Request) admission.Response {
	...
	case pair{metav1.GroupVersionKind{Group: "batch", Version: "v1", Kind: "Job"}, admissionV1.Create}:
		job := &batchv1.Job{}
		...
		job.Spec.Template.Annotations[fmt.Sprintf("%s/job-creation-timestamp", apiGroup())] = time.Now().Format(time.RFC3339)
