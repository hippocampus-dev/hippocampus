...
_LANGUAGE_BLOCK_ID = "language"
_COLLAPSE_BLOCK_ID = "collapse"
_TOGGLE_BLOCK_ID = "translations"

_LANGUAGE_ACTION_ID = "language"
_COLLAPSE_ACTION_ID = "collapse"
_TOGGLE_ACTION_ID = "translations"

_EDIT_TRANSLATION_CALLBACK_ID = "edit_translation"


async def register(bolt: slack_bolt.async_app.AsyncApp, brain: cortex.brain.Brain):
    @bolt.view(_EDIT_TRANSLATION_CALLBACK_ID)
    async def handle_edit_translations(
        ...
        setting = Translation(
            locales=[
                ...
                for selected_option in values[_LANGUAGE_BLOCK_ID][_LANGUAGE_ACTION_ID][
                    "selected_options"
                ]
            ],
            collapse=values[_COLLAPSE_BLOCK_ID][_COLLAPSE_ACTION_ID]["selected_option"][
                "value"
            ],
        ...
        await brain.save(
            "translations",
            json.dumps(
                translations.root, ensure_ascii=False, default=lambda x: x.model_dump()
            ).encode("utf-8"),
        )
    ...
    async def translation(
        ...
        await client.views_open(
            ...
            view={
                "type": "modal",
                "callback_id": _EDIT_TRANSLATION_CALLBACK_ID,
                ...
                "blocks": [
                    ...
                    {
                        "type": "input",
                        "block_id": _COLLAPSE_BLOCK_ID,
                        "label": {"type": "plain_text", "text": "折りたたみ"},
                        "element": {
                            "type": "radio_buttons",
                            "action_id": _COLLAPSE_ACTION_ID,
                            "options": [
                                {
                                    "text": {
                                        "type": "plain_text",
