...
async def register(bolt: slack_bolt.async_app.AsyncApp, brain: cortex.brain.Brain):
    ...
    async def handle_edit_avatar(
        ...
        avatar = Avatar(
            ...
            verbosity=values[VERBOSITY_BLOCK_ID][VERBOSITY_ACTION_ID]["selected_option"]["value"],
        ...
        await client.views_open(
            ...
            view={
                ...
                "blocks": [
                        ...
                        "element": {
                            ...
                            "initial_option": {
                                "text": {
                                    ...
                                    if avatars[channel_id].reasoning_effort in available_reasoning_effort
                                    else "medium",
                                },
                    ...
                    {
                        "type": "input",
                        "block_id": VERBOSITY_BLOCK_ID,
                        "label": {"type": "plain_text", "text": "Verbosity"},
                        "element": {
                            "type": "static_select",
                            "action_id": VERBOSITY_ACTION_ID,
                            "options": [
                                {
                                    "text": {
                                        "type": "plain_text",
