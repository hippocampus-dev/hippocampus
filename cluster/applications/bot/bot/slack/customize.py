...
_NAME_BLOCK_ID = "name"
_ICON_URL_BLOCK_ID = "icon_url"
_INSTRUCTION_BLOCK_ID = "instruction"
_LOCALE_BLOCK_ID = "locale"
_MODEL_BLOCK_ID = "model"
_REASONING_EFFORT_BLOCK_ID = "reasoning_effort"
_VERBOSITY_BLOCK_ID = "verbosity"
_TOGGLE_BLOCK_ID = "settings"

_NAME_ACTION_ID = "name"
_ICON_URL_ACTION_ID = "icon_url"
_INSTRUCTION_ACTION_ID = "instruction"
_LOCALE_ACTION_ID = "locale"
_MODEL_ACTION_ID = "model"
_REASONING_EFFORT_ACTION_ID = "reasoning_effort"
_VERBOSITY_ACTION_ID = "verbosity"
_TOGGLE_ACTION_ID = "settings"

_EDIT_AVATAR_CALLBACK_ID = "edit_avatar"

_OPTION_VALUE_LIMIT = 20


async def register(bolt: slack_bolt.async_app.AsyncApp, brain: cortex.brain.Brain):
    @bolt.view(_EDIT_AVATAR_CALLBACK_ID)
    async def handle_edit_avatar(
        ...
        avatar = Avatar(
            ...
            icon_url=values[_ICON_URL_BLOCK_ID][_ICON_URL_ACTION_ID]["value"],
            instruction=values[_INSTRUCTION_BLOCK_ID][_INSTRUCTION_ACTION_ID]["value"],
            locale=values[_LOCALE_BLOCK_ID][_LOCALE_ACTION_ID]["selected_option"][
                "value"
            ],
            model=values[_MODEL_BLOCK_ID][_MODEL_ACTION_ID]["selected_option"]["value"],
            reasoning_effort=values[_REASONING_EFFORT_BLOCK_ID][
                _REASONING_EFFORT_ACTION_ID
            ]["selected_option"]["value"],
            verbosity=values[_VERBOSITY_BLOCK_ID][_VERBOSITY_ACTION_ID][
                "selected_option"
            ]["value"],
            enabled=values[_TOGGLE_BLOCK_ID][_TOGGLE_ACTION_ID]["selected_option"][
                "value"
            ],
        )

        errors = {}
        if len(avatar.name) > _OPTION_VALUE_LIMIT:
            ...
            async with aiohttp.ClientSession(trust_env=True) as session:
                async with session.get(avatar.icon_url) as response:
                    if response.status != 200:
                        errors[_ICON_URL_BLOCK_ID] = (
                            "アイコン画像のURLにアクセスできませんでした。"
                        )
        except aiohttp.InvalidURL:
            errors[_ICON_URL_BLOCK_ID] = "アイコン画像のURLが無効です。"
        except (
        ...
        await client.views_open(
            ...
            view={
                ...
                "blocks": [
                    ...
                    {
                        "type": "input",
                        "block_id": _ICON_URL_BLOCK_ID,
                        "label": {"type": "plain_text", "text": "アイコン画像のURL"},
                        "element": {
                            "type": "plain_text_input",
                            "action_id": _ICON_URL_ACTION_ID,
                    ...
                    {
                        "type": "input",
                        "block_id": _INSTRUCTION_BLOCK_ID,
                        "label": {"type": "plain_text", "text": "命令"},
                        "element": {
                            "type": "plain_text_input",
                            "multiline": True,
                            "action_id": _INSTRUCTION_ACTION_ID,
                    ...
                    {
                        "type": "input",
                        "block_id": _LOCALE_BLOCK_ID,
                        "label": {"type": "plain_text", "text": "言語"},
                        "element": {
                            "type": "static_select",
                            "action_id": _LOCALE_ACTION_ID,
                            "options": [
                                {
                    ...
                    {
                        "type": "input",
                        "block_id": _MODEL_BLOCK_ID,
                        "label": {"type": "plain_text", "text": "モデル"},
                        "element": {
                            "type": "static_select",
                            "action_id": _MODEL_ACTION_ID,
                            "options": [
                                {
                            ...
                            "initial_option": {
                                "text": {
                                    ...
                                    else cortex.llm.openai.model.CompletionModel.GPT_5_MINI_ALIAS,
                                },
                            ...
                            if channel_id in avatars
                                ...
                                "text": {
                                    "type": "plain_text",
                                    "text": cortex.llm.openai.model.CompletionModel.GPT_5_MINI_ALIAS,
                                },
                                "value": cortex.llm.openai.model.CompletionModel.GPT_5_MINI_ALIAS,
                            },
                        },
                    },
                    {
                        "type": "input",
                        "block_id": _REASONING_EFFORT_BLOCK_ID,
                        "label": {"type": "plain_text", "text": "Reasoning Effort"},
                        "element": {
                            "type": "static_select",
                            "action_id": _REASONING_EFFORT_ACTION_ID,
                            "options": [
                                {
                                    "text": {
                                        "type": "plain_text",
                    ...
                    {
                        "type": "input",
                        "block_id": _VERBOSITY_BLOCK_ID,
                        "label": {"type": "plain_text", "text": "Verbosity"},
                        "element": {
                            "type": "static_select",
                            "action_id": _VERBOSITY_ACTION_ID,
                            "options": [
                                {
                                    "text": {
                                        "type": "plain_text",
                                ...
                                for verbosity in available_verbosity
                            ],
                            "initial_option": {
                                "text": {
                                    "type": "plain_text",
                                    "text": avatars[channel_id].verbosity
                                    if avatars[channel_id].verbosity
                                    in available_verbosity
                                    else "medium",
                                },
                                "value": avatars[channel_id].verbosity
                                if avatars[channel_id].verbosity in available_verbosity
                                else "medium",
                            }
                            if channel_id in avatars
                            else {
                    ...
                    {
                        "type": "input",
                        "block_id": _TOGGLE_BLOCK_ID,
                        "label": {"type": "plain_text", "text": "設定"},
                        "element": {
                            "type": "radio_buttons",
                            "action_id": _TOGGLE_ACTION_ID,
                            "options": [
                                {
                                    "text": {
                                        "type": "plain_text",
