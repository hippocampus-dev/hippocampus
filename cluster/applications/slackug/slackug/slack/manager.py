...
class UserGroups(
    pydantic.RootModel[collections.abc.MutableMapping[str, UserGroup]],
...
_NAME_BLOCK_ID = "name"
_NAME_ACTION_ID = "name"
_USERS_BLOCK_ID = "users"
_USERS_ACTION_ID = "users"
_LOCAL_BLOCK_ID = "local"
_LOCAL_ACTION_ID = "local"

_ADD_CONFIRM_CALLBACK_ID = "add-confirm"
_EDIT_CONFIRM_CALLBACK_ID = "edit-confirm"
_DELETE_CONFIRM_CALLBACK_ID = "delete-confirm"
_USE_CONFIRM_CALLBACK_ID = "use-confirm"

_EDIT_GROUP_CALLBACK_ID = "edit-group"
_EDIT_GROUP_BLOCK_ID = "edit"
_EDIT_GROUP_ACTION_ID = "edit"

_DELETE_GROUP_CALLBACK_ID = "delete-group"
_DELETE_GROUP_BLOCK_ID = "delete"
_DELETE_GROUP_ACTION_ID = "delete"

_LIST_GROUP_CALLBACK_ID = "list-group"
_LIST_GROUP_BLOCK_ID = "list"
_LIST_GROUP_ACTION_ID = "list"
_LIST_GROUP_NEXT_ACTION_ID = "list-next"
_LIST_GROUP_PREV_ACTION_ID = "list-prev"

_ITEMS_PER_PAGE = 50

_SELECT_GROUP_CALLBACK_ID = "select-group"
_SELECT_GROUP_BLOCK_ID = "select"
_SELECT_GROUP_ACTION_ID = "select"
...
async def register(bolt: slack_bolt.async_app.AsyncApp, brain: brain.Brain):
    ...
    async def handle_add_group(
        ...
        is_local = (
            values[_LOCAL_BLOCK_ID][_LOCAL_ACTION_ID]["selected_option"]["value"]
            == Toggle.On
        )

        group = UserGroup(
            name=values[_NAME_BLOCK_ID][_NAME_ACTION_ID]["value"],
            users=values[_USERS_BLOCK_ID][_USERS_ACTION_ID]["selected_conversations"],
            channel_id=private_metadata.channel_id if is_local else None,
        )

        errors = {}
        if len(group.name) > _OPTION_VALUE_LIMIT:
            errors[_NAME_BLOCK_ID] = (
                f"ユーザグループ名は{_OPTION_VALUE_LIMIT}文字以下にしてください。"
            )
        ...
        groups = (
            UserGroups.model_validate_json(restored_groups)
            if restored_groups
            else UserGroups.model_validate({})
        )
        ...
        await brain.save(
            "usergroups",
            json.dumps(
                groups.root, ensure_ascii=False, default=lambda x: x.model_dump()
            ).encode("utf-8"),
        )
    ...
    async def handle_use_confirm(
        ...
        if (
            group.channel_id is not None
            and group.channel_id != private_metadata.channel_id
        ):
            await retryable_client.chat_postEphemeral(
                channel=private_metadata.channel_id,
                user=private_metadata.user_id,
        ...
        await retryable_client.chat_postMessage(
            channel=private_metadata.channel_id, text=users_text
        )
        ...
        await retryable_client.views_open(
            ...
            view={
                ...
                "blocks": [
                    ...
                    {
                        "type": "input",
                        "block_id": _LOCAL_BLOCK_ID,
                        "label": {"type": "plain_text", "text": "チャンネル限定"},
                        "element": {
                            "type": "radio_buttons",
                            "action_id": _LOCAL_ACTION_ID,
                            "options": [
                                {
                                    "text": {
                                        "type": "plain_text",
    ...
    async def edit_group(
        ...
        await retryable_client.views_open(
            ...
            view={
                "type": "modal",
                "callback_id": _EDIT_GROUP_CALLBACK_ID,
                "private_metadata": json.dumps(
                    private_metadata.model_dump(), ensure_ascii=False
                ),
                ...
                "blocks": [
                    {
                        "type": "input",
                        "block_id": _EDIT_GROUP_BLOCK_ID,
                        "label": {"type": "plain_text", "text": "ユーザグループ名"},
                        "element": {
                            "type": "external_select",
                            "action_id": _EDIT_GROUP_ACTION_ID,
                            "placeholder": {
                                "type": "plain_text",
                                "text": "ユーザグループ名を入力してください",
                            },
                            "min_query_length": 0,
                        },
                    },
    ...
    @bolt.options(_EDIT_GROUP_ACTION_ID)
    async def handle_edit_group_options(
        ...
        filtered_groups = {
            ...
            or group.channel_id == private_metadata.channel_id
        }
        ...
        for name, group in filtered_groups.items():
            if query in name.lower():
                option_text = (
                    name[: _OPTION_TEXT_LIMIT - 3] + "..."
                    if len(name) > _OPTION_TEXT_LIMIT
                    else name
                )
                options.append(
                    {
    ...
    @bolt.view(_EDIT_GROUP_CALLBACK_ID)
    async def handle_edit_group(
        ...
        values = body["view"]["state"]["values"]
        name = values[_EDIT_GROUP_BLOCK_ID][_EDIT_GROUP_ACTION_ID]["selected_option"][
            "value"
        ]
    ...
    async def delete_group(
        ...
        await retryable_client.views_open(
            ...
            view={
                "type": "modal",
                "callback_id": _DELETE_GROUP_CALLBACK_ID,
                "private_metadata": json.dumps(
                    private_metadata.model_dump(), ensure_ascii=False
                ),
                ...
                "blocks": [
                    {
                        "type": "input",
                        "block_id": _DELETE_GROUP_BLOCK_ID,
                        "label": {"type": "plain_text", "text": "ユーザグループ名"},
                        "element": {
                            "type": "external_select",
                            "action_id": _DELETE_GROUP_ACTION_ID,
                            "placeholder": {
                                "type": "plain_text",
                                "text": "ユーザグループ名を入力してください",
                            },
    ...
    @bolt.options(_DELETE_GROUP_ACTION_ID)
    ...
    @bolt.view(_DELETE_GROUP_CALLBACK_ID)
    async def handle_delete_group(
        ...
        values = body["view"]["state"]["values"]
        name = values[_DELETE_GROUP_BLOCK_ID][_DELETE_GROUP_ACTION_ID][
            "selected_option"
        ]["value"]
    ...
    async def list_group(
        ...
        private_metadata = PrivateMetadata(
            channel_id=body["channel_id"], user_id=body["user_id"], list_page=page
        )
        ...
        total_pages = (total_groups + _ITEMS_PER_PAGE - 1) // _ITEMS_PER_PAGE

        start_idx = page * _ITEMS_PER_PAGE
        end_idx = min(start_idx + _ITEMS_PER_PAGE, total_groups)
                    ...
                    "elements": [
                        {
                            ...
                            "value": group.name,
                            "action_id": _LIST_GROUP_ACTION_ID,
                        },
                    ],
                },
            )
                ...
                nav_elements.append(
                    {
                        ...
                        "action_id": _LIST_GROUP_PREV_ACTION_ID,
                    }
                )
                ...
                nav_elements.append(
                    {
                        ...
                        "action_id": _LIST_GROUP_NEXT_ACTION_ID,
                    }
                )
        ...
        await retryable_client.views_open(
            ...
            view={
                "type": "modal",
                "callback_id": _LIST_GROUP_CALLBACK_ID,
                "private_metadata": json.dumps(
                    private_metadata.model_dump(), ensure_ascii=False
                ),
                "title": {
                    "type": "plain_text",
                    "text": "ユーザグループにメンションする",
                },
                "blocks": blocks,
                "close": {"type": "plain_text", "text": "キャンセル"},
            },
    ...
    @bolt.action(_LIST_GROUP_ACTION_ID)
    ...
    @bolt.action(_LIST_GROUP_PREV_ACTION_ID)
    async def handle_list_group_prev(
        ...
        start_idx = new_page * _ITEMS_PER_PAGE
        end_idx = min(start_idx + _ITEMS_PER_PAGE, total_groups)
        page_groups = groups_list[start_idx:end_idx]
    ...
    @bolt.action(_LIST_GROUP_NEXT_ACTION_ID)
    ...
    async def select_group(
        ...
        await retryable_client.views_open(
            ...
            view={
                "type": "modal",
                "callback_id": _SELECT_GROUP_CALLBACK_ID,
                "private_metadata": json.dumps(
                    private_metadata.model_dump(), ensure_ascii=False
                ),
                ...
                "blocks": [
                    {
                        "type": "input",
                        "block_id": _SELECT_GROUP_BLOCK_ID,
                        "label": {"type": "plain_text", "text": "ユーザグループ名"},
                        "element": {
                            "type": "external_select",
                            "action_id": _SELECT_GROUP_ACTION_ID,
                            "placeholder": {
                                "type": "plain_text",
                                "text": "ユーザグループ名を入力してください",
                            },
    ...
    @bolt.options(_SELECT_GROUP_ACTION_ID)
    ...
    @bolt.view(_SELECT_GROUP_CALLBACK_ID)
    async def handle_select_group(
        ...
        values = body["view"]["state"]["values"]
        name = values[_SELECT_GROUP_BLOCK_ID][_SELECT_GROUP_ACTION_ID][
            "selected_option"
        ]["value"]
