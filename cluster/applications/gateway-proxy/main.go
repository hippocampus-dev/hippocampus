...
func main() {
	...
	// require leader election). After the first Update, Ready stays true
	// unless every desired bind failed; an empty desired set still marks the
	// pod Ready since WaitForCacheSync guarantees a populated cache before
	// reconcile runs.
