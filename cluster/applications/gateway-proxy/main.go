...
func main() {
	...
	webhookServer.Register("/validate", &webhook.Admission{Handler: &handler.GatewayHandler{Client: m.GetClient(), Decoder: admission.NewDecoder(m.GetScheme()), ControllerName: controllerName}})
