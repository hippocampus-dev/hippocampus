...
func (h *handler) Handle(ctx context.Context, req admission.Request) admission.Response {
	...
	case metav1.GroupVersionKind{Group: "", Version: "v1", Kind: "Pod"}:
		...
		excludeInboundPorts := pod.Annotations["traffic.sidecar.istio.io/excludeInboundPorts"]
		if excludeInboundPorts == "" {
			pod.Annotations["traffic.sidecar.istio.io/excludeInboundPorts"] = "65532"
		} else if !strings.Contains(","+excludeInboundPorts+",", ",65532,") {
			pod.Annotations["traffic.sidecar.istio.io/excludeInboundPorts"] = excludeInboundPorts + ",65532"
		}
