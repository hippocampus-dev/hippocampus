// Package v1 contains API Schema definitions for the dedicated-container-ingress v1 API group
// +kubebuilder:object:generate=true
// +groupName=dedicated-container-ingress.kaidotio.github.io
package v1
...
func apiGroup() string {
	defaultGroup := "dedicated-container-ingress.kaidotio.github.io"
