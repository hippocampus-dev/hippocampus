...
func NewGarbageCollector(interval time.Duration, lifetime time.Duration, redisClient *redis.Client, clientset kubernetes.Interface) *GarbageCollector {
