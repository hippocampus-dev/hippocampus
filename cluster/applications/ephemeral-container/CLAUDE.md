...
6. **Workflow Automation**: n8n CLI (for workflow import/export and management)
...
6. **n8n workflow management**: Import/export workflows and manage n8n instances via CLI
