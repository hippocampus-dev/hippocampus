...
impl ModelManager {
    ...
    pub async fn get_or_load_model(
        ...
        let model = rust_de_llama::LlamaModel::load_from_file(&model_path, n_gpu_layers, n_cpu_moe)
        ...
        tracing::info!(
            "Initializing model '{}' with: n_ctx={}, n_parallel={}, n_batch={}, n_ubatch={}, n_cpu_moe={}",
            model_name,
            n_ctx,
            n_parallel,
            n_batch,
