...
class DataStore(abc.ABC):
    ...
    async def upsert(
        ...
        document_category_segments = await memory_bank.categorizer.categorize_documents(
        ...
        async def process_category(
            ...
            if existing_memory:
                category_text = await memory_bank.merger.merge_memories(
                    existing_memory,
                    category_text,
                    category,
                )
    ...
    async def query(
        ...
        for query in empty_queries:
            ...
            results.append(memory_bank.model.QueryResult(
                query=query.query,
