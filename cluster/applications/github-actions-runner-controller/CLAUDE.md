...
- Controller image: `ghcr.io/kaidotio/hippocampus/skaffold`
...
3. **Manager** (`main.go`):
   ...
   - Configuration via flags/environment variables:
     ...
     - `--push-registry-url` / `--pull-registry-url` (default: `ghcr.io/kaidotio/hippocampus/github-actions-runner-controller`)
