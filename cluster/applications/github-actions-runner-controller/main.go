...
func main() {
	...
	flag.StringVar(&pushRegistryURL, "push-registry-url", envOrDefaultValue("PUSH_REGISTRY_URL", "ghcr.io/kaidotio/hippocampus/github-actions-runner-controller"), "URL of Docker Registry used as push destination.")
	flag.StringVar(&pullRegistryURL, "pull-registry-url", envOrDefaultValue("PULL_REGISTRY_URL", "ghcr.io/kaidotio/hippocampus/github-actions-runner-controller"), "URL of Docker Registry used as pull source.")
