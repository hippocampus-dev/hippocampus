...
func main() {
	...
	var keepalive bool
	flag.StringVar(&localAddress, "local-address", envOrDefaultValue("LOCAL_ADDRESS", "127.0.0.1:16379"), "Local listen address")
	flag.StringVar(&remoteAddress, "remote-address", envOrDefaultValue("REMOTE_ADDRESS", "127.0.0.1:6379"), "Remote upstream address")
	flag.StringVar(&monitorAddress, "monitor-address", envOrDefaultValue("MONITOR_ADDRESS", "127.0.0.1:8080"), "Monitor server address")
	...
	flag.StringVar(&readerRemoteAddress, "reader-remote-address", envOrDefaultValue("READER_REMOTE_ADDRESS", remoteAddress), "Reader remote upstream address")
