...
CSViewer is a lightweight web-based CSV file viewer built with Preact and TailwindCSS.
It provides interactive CSV browsing with fuzzy search capabilities, markdown link rendering, and URL-based state management.
