// Package v1 contains API Schema definitions for the owasp-zap v1 API group
// +kubebuilder:object:generate=true
// +groupName=owasp-zap.kaidotio.github.io
package v1
...
func apiGroup() string {
	defaultGroup := "owasp-zap.kaidotio.github.io"
