...
func (r *ExporterReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if tokenExpiresAt != "" {
		if exporter.Spec.Template.ObjectMeta.Annotations == nil {
			exporter.Spec.Template.ObjectMeta.Annotations = map[string]string{}
		}
		exporter.Spec.Template.ObjectMeta.Annotations[expiresAtAnnotation] = tokenExpiresAt
	}
