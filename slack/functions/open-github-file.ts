...
export default SlackFunction(def, async (
    {inputs, token}: { inputs: { github_access_token_id: string, url: string }, token: string }
    ...
    try {
        ...
        const destination = url.replace(pattern, "https://raw.githubusercontent.com/$1/$2/$3/$4");
