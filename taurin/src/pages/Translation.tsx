    ...
    [
      ...
      h(
        "div",
        {
          ...
          class:
            "w-full lg:w-1/2 mt-4 bg-white p-4 rounded-md shadow-md h-64 overflow-y-auto",
        },
        [
          ...
          content.length === 0
            ? h(
                ...
                "No content yet. Click Start to begin.",
              )
            : h(
                "div",
                {
                  class:
                    "whitespace-pre-wrap break-words font-mono text-medium",
                },
                content,
              ),
        ],
