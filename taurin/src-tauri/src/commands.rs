...
pub const BAKERY_URL: &str = "https://bakery.minikube.127.0.0.1.nip.io/callback";
pub const CORTEX_API_URL: &str = "https://cortex-api.minikube.127.0.0.1.nip.io/v1";
pub const CORTEX_WEBSOCKET_URL: &str = "wss://cortex-api.minikube.127.0.0.1.nip.io/v1";
