...
_TARGETS=(
  ...
  /home/${_USER}/.config/easyeffects/db/gaterc
  /home/${_USER}/.config/easyeffects/db/rnnoiserc
  ...
  /home/${_USER}/.codex/AGENTS.md
  /home/${_USER}/.gemini/settings.json
  /home/${_USER}/.gemini/AGENTS.md
