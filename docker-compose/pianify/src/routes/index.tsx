...
function scoreXmlQueryOptions(filename: string) {
  return queryOptions({
    queryKey: ["score", filename],
    queryFn: () => fetchScoreXml({ data: { filename } }),
  });
}
...
function Player() {
  ...
  const scoreQuery = useQuery({
    ...scoreXmlQueryOptions(selectedFile),
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="px-3 py-3 space-y-4 sm:px-6 sm:py-6">
        ...
        {parsedScore !== null && (
          <>
            ...
            <SheetMusic
              ...
              measureTimings={parsedScore.score.metadata.measureTimings}
            />
            ...
            <div>
              <FallingNotes
                notes={filteredNotes}
                currentTimeMs={currentTimeMs}
                bpm={parsedScore.score.metadata.tempoChanges[0].bpm}
              />
        ...
        {parsedScore === null && !scoreQuery.isLoading && (
