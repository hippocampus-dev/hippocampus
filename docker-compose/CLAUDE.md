...
3. **Observability Stack**:
   ...
   - OpenTelemetry Collector (contrib) - Telemetry pipeline for traces (→ Jaeger), metrics (→ Prometheus on :8889), and logs (→ logging exporter). Accessed via Envoy at https://opentelemetry-collector.127.0.0.1.nip.io, requires mkcert CA trust
