...
|------------|---------|------------------|
| dedicated-container-ingress-controller | DedicatedContainerIngress | `cluster/manifests/dedicated-remotty/` |
...
CRD controllers need the VARIANT environment variable to prefix API groups during Skaffold development.
This allows development and production CRDs to coexist without conflicts.
