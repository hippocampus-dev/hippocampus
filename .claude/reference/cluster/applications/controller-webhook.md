...
Controllers with webhooks that use custom annotation groups need the VARIANT environment variable to prefix annotation groups during Skaffold development.
