...
Webhooks that use custom annotation groups need the VARIANT environment variable to prefix annotation groups during Skaffold development.
This allows development and production webhooks to coexist without conflicts.
