...
* Set `.DEFAULT_GOAL` on the first line, pointing at a target that exists in the file
...
| `make dev` | Start development mode (omit when the application has no local run loop) |
