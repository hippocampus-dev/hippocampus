...
6. Do NOT add `if: github.repository_owner == 'kaidotio'` condition:
...
The scan workflow uses Trivy to detect vulnerabilities and automatically creates GitHub issues when CRITICAL or HIGH severity vulnerabilities are found.
