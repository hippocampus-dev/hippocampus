...
Before creating a rule, verify what is being asked and search `.claude/rules/` and `.claude/skills/` for the topic. If unclear, clarify with the user first.
...
| Prescriptive? (requirement/choice/warning, not current state) | Move to CLAUDE.md |
