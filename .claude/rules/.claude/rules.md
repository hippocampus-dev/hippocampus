...
* State a convention in exactly one place - put it in `files/home/kai/.config/claudex/config/CLAUDE*.md` when other agent tools must honor it, otherwise in `.claude/rules/` which reaches Claude Code only
