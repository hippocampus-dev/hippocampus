...
curl -fsSLo /dev/null --retry 5 --retry-all-errors -X POST -H "Authorization: token $GH_TOKEN" -H "Accept: application/vnd.github+json" "https://api.github.com/repos/${GITHUB_REPOSITORY}/dependency-graph/snapshots" -d "@${snapshot_file}"
