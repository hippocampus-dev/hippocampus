...
curl -fsSLo /dev/null -X POST -H "Authorization: token $GH_TOKEN" -H "Accept: application/vnd.github+json" "https://api.github.com/repos/${GITHUB_REPOSITORY}/dependency-graph/snapshots" -d "@${snapshot_file}"
