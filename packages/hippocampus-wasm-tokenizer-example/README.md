...
<!-- TOC -->
* [hippocampus-wasm-tokenizer-example](#hippocampus-wasm-tokenizer-example)
  * [Features](#features)
  * [Usage](#usage)
  * [Development](#development)
<!-- TOC -->

hippocampus-wasm-tokenizer-example is a sample tokenizer plugin that demonstrates how to create custom tokenizers for hippocampus using WebAssembly.
...
All tokenizer plugins must implement the WIT interface defined in `/opt/hippocampus/packages/hippocampus-core/wit/tokenizer.wit`:
