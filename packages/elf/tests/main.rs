...
fn ok_64bit() -> Result<(), error::Error> {
    ...
    if let elf::elf_header::Header::Header64(header) = e.elf_header {
        ...
        assert_eq!(header.type_, elf::elf_header::Type::DYN);
    ...
    {
        assert_eq!(section_header.type_, elf::section_header::Type::SHT_SYMTAB);
    ...
    if let Some(elf::symbol::Symbol::Symbol64(symbol)) = e.symbol_table.get("main") {
        ...
        assert_eq!(symbol.type_, elf::symbol::Type::STT_FUNC);
